...
class National_Park_ProjectSpider(Spider):
    name = "Rocky_Mountain_Aspenglen_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=72084&startIdx='+str(i) for i in range(0,75,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Aspenglen Campground']
            item['Longtitude']= ['-105.59269']
            item['Latitude']= ['40.400306']
            item['Stars'] = ['4.6']
            item['Reviews'] = ['802']
            item['Site'] = Site
