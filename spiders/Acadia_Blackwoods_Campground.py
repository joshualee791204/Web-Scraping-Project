...
class National_Park_ProjectSpider(Spider):
    name = "Acadia_Blackwoods_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70990&startIdx='+str(i) for i in range(0,300,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Blackwoods Campground']
            item['Longtitude']= ['-68.210843']
            item['Latitude']= ['44.313131']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['3479']
            item['Site'] = Site
