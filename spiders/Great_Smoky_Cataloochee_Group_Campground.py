...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Cataloochee_Group_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Cataloochee_Group_Camp/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70912&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Cataloochee Group Campground']
            item['Longtitude']= ['-83.074198']
            item['Latitude']= ['35.65089']
            item['Stars'] = ['4.9']
            item['Reviews'] = ['22']
            item['Site'] = Site
