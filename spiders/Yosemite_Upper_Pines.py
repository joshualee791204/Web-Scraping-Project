...
class National_Park_ProjectSpider(Spider):
    name = "Yosemite_Upper_Pines"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70925&startIdx='+str(i) for i in range(0,250,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Upper Pines']
            item['Longtitude']= ['-119.56555']
            item['Latitude']= ['37.739132']
            item['Stars'] = ['4.3']
            item['Reviews'] = ['4621']
            item['Site'] = Site
