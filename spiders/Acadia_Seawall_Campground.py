...
class National_Park_ProjectSpider(Spider):
    name = "Acadia_Seawall_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=94719&startIdx='+str(i) for i in range(0,225,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Seawall Campground']
            item['Longtitude']= ['-68.305995']
            item['Latitude']= ['44.242229']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['1788']
            item['Site'] = Site
