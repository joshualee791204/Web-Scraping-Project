...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Big_Creek_Group_Camp"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Big_Creek_Group_Camp/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70915&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Big Creek Group Camp']
            item['Longtitude']= ['-83.10927']
            item['Latitude']= ['35.752268']
            item['Stars'] = ['5']
            item['Reviews'] = ['7']
            item['Site'] = Site
