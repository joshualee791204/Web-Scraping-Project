...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Collins_Creek_Picnic_Pavilion"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Collins_Creek_Picnic_Pavilion/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70961&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Collins Creek Picnic Pavilion']
            item['Longtitude']= ['-83.44738089999998']
            item['Latitude']= ['35.4309291']
            item['Stars'] = ['4.7']
            item['Reviews'] = ['3']
            item['Site'] = Site
