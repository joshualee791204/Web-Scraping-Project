...
class National_Park_ProjectSpider(Spider):
    name = "Joshua_Tree_Black_Rock_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70953&startIdx='+str(i) for i in range(0,100,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Black Rock Campground']
            item['Longtitude']= ['-116.389757']
            item['Latitude']= ['34.073333']
            item['Stars'] = ['4.3']
            item['Reviews'] = ['1575']
            item['Site'] = Site
