...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Anthony_Creek_house_Camp"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsiteFilterAction.do?sitefilter=ALL&startIdx=0&contractCode=NRSO&parkId=70966&startIdx='+str(i) for i in range(0,25,25)]
