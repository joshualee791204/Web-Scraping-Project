...
class National_Park_ProjectSpider(Spider):
    name = "Arches_Devils_Garden_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=74066&startIdx='+str(i) for i in range(0,75,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['ParkName']=['Arches']
            item['Location']= ['Devils Garden Campground']
            item['Longtitude']= ['-109.589167']
            item['Latitude']= ['38.776944']
            item['Stars'] = ['4.7']
            item['Reviews'] = ['557']
            item['Site'] = Site
