...
class National_Park_ProjectSpider(Spider):
    name = "Glacier_Fish_Creek_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70974&startIdx='+str(i) for i in range(0,175,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Fish Creek Campground']
            item['Longtitude']= ['-113.985278']
            item['Latitude']= ['48.5477789']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['1499']
            item['Site'] = Site
