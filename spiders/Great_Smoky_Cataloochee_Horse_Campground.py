...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Cataloochee_Horse_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Cataloochee_Horse_Camp/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70963&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Cataloochee Horse Campground']
            item['Longtitude']= ['-83.1125']
            item['Latitude']= ['35.627778']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['55']
            item['Site'] = Site
