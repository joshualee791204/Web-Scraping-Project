...
class National_Park_ProjectSpider(Spider):
    name = "Zion_Watchman_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70923&startIdx='+str(i) for i in range(0,200,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['ParkName']=['Zion']
            item['Location']= ['Watchman Campground']
            item['Longtitude']= ['-112.986389']
            item['Latitude']= ['37.198611']
            item['Stars'] = ['4.6']
            item['Reviews'] = ['3909']
            item['Site'] = Site
