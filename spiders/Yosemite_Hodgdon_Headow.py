...
class National_Park_ProjectSpider(Spider):
    name = "Yosemite_Hodgdon_Headow"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70929&startIdx='+str(i) for i in range(0,125,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Hodgdon Headow']
            item['Longtitude']= ['-119.86614']
            item['Latitude']= ['37.798252']
            item['Stars'] = ['3.8']
            item['Reviews'] = ['1302']
            item['Site'] = Site
