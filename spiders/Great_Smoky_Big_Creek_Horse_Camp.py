...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Big_Creek_Horse_Camp"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Big_Creek_Horse_Camp/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70965&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Big Creek Horse Camp']
            item['Longtitude']= ['-83.107208']
            item['Latitude']= ['35.754215']
            item['Stars'] = ['4.4']
            item['Reviews'] = ['27']
            item['Site'] = Site
