...
class National_Park_ProjectSpider(Spider):
    name = "Yosemite_North_Pines"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70927&startIdx='+str(i) for i in range(0,100,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['North Pines']
            item['Longtitude']= ['-119.565556']
            item['Latitude']= ['37.741944']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['1072']
            item['Site'] = Site
