...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Cades_Cove_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70969&startIdx='+str(i) for i in range(0,175,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Cades Cove Campground']
            item['Longtitude']= ['-83.774943']
            item['Latitude']= ['35.602231']
            item['Stars'] = ['4.5']
            item['Reviews'] = ['1931']
            item['Site'] = Site
