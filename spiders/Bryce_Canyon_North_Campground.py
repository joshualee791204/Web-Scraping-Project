...
class National_Park_ProjectSpider(Spider):
    name = "Bryce_Canyon_North_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=74065&startIdx='+str(i) for i in range(0,125,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['NorthCampground']
            item['Longtitude']= ['-112.166903']
            item['Latitude']= ['37.635203']
            item['Stars'] = ['4.6']
            item['Reviews'] = ['257']
            item['Site'] = Site
