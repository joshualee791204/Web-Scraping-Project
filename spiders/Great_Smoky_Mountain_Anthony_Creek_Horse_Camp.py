...
class National_Park_ProjectSpider(Spider):
    name = "Great_Smoky_Mountain_Anthony_Creek_house_Camp"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/camping/Anthony_Creek_Horse_Camp/r/campsiteSearch.do?search=site&page=siteresult&contractCode=NRSO&parkId=70966&startIdx='+str(i) for i in range(0,25,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Anthony Creek house Camp']
            item['Longtitude']= ['-83.76636']
            item['Latitude']= ['35.601777']
            item['Stars'] = ['4.3']
            item['Reviews'] = ['12']
            item['Site'] = Site
