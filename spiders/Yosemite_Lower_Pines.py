...
class National_Park_ProjectSpider(Spider):
    name = "Yosemite_Lower_Pines"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=70928&startIdx='+str(i) for i in range(0,75,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Lower Pines']
            item['Longtitude']= ['-119.56642']
