...
class National_Park_ProjectSpider(Spider):
    name = "Glacier_Many_Glacier_Campground"
    allowed_urls = ['https://www.recreation.gov']
    start_urls = ['https://www.recreation.gov/campsitePaging.do?contractCode=NRSO&parkId=136190&startIdx='+str(i) for i in range(0,175,25)]
    ...
    def parse(self,response):
        ...
        for i in review_t: 
            ...
            item['Location']= ['Many Glacier Campground']
            item['Longtitude']= ['-113.677342']
            item['Latitude']= ['48.796677']
            item['Stars'] = ['4.6']
            item['Reviews'] = ['340']
            item['Site'] = Site
